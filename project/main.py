...
def get_parameters():
    ...
    parser.add_argument('--model', type=str, default='resnet', choices=['resnet', 'transformers', 'i3d'])
    ...
    parser.add_argument('--segmentation_data_path', type=str, default="/workspace/data/segmentation_dataset_512",
                        help="segmentation dataset with mediapipe method.")
...
if __name__ == '__main__':
    ...
    if config.pre_process_flag:
        ...
        DATA_PATH = config.segmentation_data_path
    else:
