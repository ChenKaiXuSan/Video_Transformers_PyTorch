...
MAIN_FILE_PATH = '/workspace/Video_Transformers_PyTorch/project/main.py'
...
def get_parameters():
    ...
    parser.add_argument('--model', type=str, default='transformers', choices=['resnet', 'transformers', 'i3d'])
        ...
        for frames in VIDEO_FRAME:
            ...
            if transfor_learning:
                ...
                if not pre_process_flag:
                    ...
                    log_path = '/workspace/Video_Transformers_PyTorch/logs/' + symbol.join([version, model]) + '.log'
